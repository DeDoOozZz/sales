...
//                            });
            ...
            <div class="form-group">
                ...
                <input type="email" placeholder="test@example.com" name="email" value="<?= set_value('email') ?>"
                       class="form-control input-dark" autocomplete="off">
            </div>

            <div class="form-group">
                <label class="control-label"><?= lang('users_password') ?></label>
                <input type="password" id="inputPassword" name="password" placeholder="<?= lang('users_password') ?>"
                       class="form-control input-dark" autocomplete="off">
            ...
            <div class="form-group checkbox">
                <label>
                    <input type="checkbox"> <?= lang('users_keep') ?> </label>
            </div>
            ...
            <div class="form-group">
                <button type="button" onclick="window.location= '<?= site_url('admin/login/forget_password') ?>'" class="btn btn-dark  btn-block text-left" value="Forgot password">
                    <i class="fa-lock"></i>
                    Forgot password
                </button>
            </div>
