...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">List Of Certificates</h3>
        <div class="panel-options">
            <a href="<?php echo site_url('admin/certificates/manage'); ?>" class="btn btn-secondary btn-sm" style="color:#fff">Add</a>
        </div>
    </div>
        ...
        <table class="table table-bordered table-striped" id="datatable">
            ...
            <tbody class="middle-align">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo site_url('admin/certificates/manage/'.$item->certificate_id); ?>" class="btn btn-orange btn-sm btn-icon icon-left">
                            Edit
                        </a>

                         <a data-href="<?php echo site_url('admin/certificates/delete/'.$item->certificate_id); ?>" class="btn btn-danger btn-sm btn-icon btn-delete"
