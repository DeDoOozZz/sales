...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-options">
            <a href="<?php echo site_url('admin/grades/manage'); ?>" class="btn btn-secondary btn-sm" style="color:#fff">Add</a>
        </div>
    </div>
            ...
            <tbody class="middle-align">
                <?php foreach ($items as $item): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo site_url('admin/grades/manage/' . $item->grade_id); ?>" class="btn btn-orange btn-sm btn-icon icon-left">
                                Edit
                            </a>

                            <a data-href="<?php echo site_url('admin/grades/delete/' . $item->grade_id); ?>" class="btn btn-danger btn-sm btn-icon btn-delete"
