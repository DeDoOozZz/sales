...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-options">
            <a href="<?php echo site_url('admin/users/manage'); ?>" class="btn btn-secondary btn-sm" style="color:#fff">Add</a>
        </div>
    </div>
            ...
            <tbody class="middle-align">
                <?php foreach ($items as $item): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo site_url('admin/users/manage/' . $item->user_id); ?>" class="btn btn-orange btn-sm btn-icon icon-left">
                                Edit
                            </a>

                            <a data-href="<?php echo site_url('admin/users/delete/' . $item->user_id); ?>" class="btn btn-danger btn-sm btn-icon btn-delete"
