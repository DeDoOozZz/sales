...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">List Of Service Providers</h3>
        <div class="panel-options">
            <a href="<?php echo site_url('admin/service_providers/manage'); ?>" class="btn btn-secondary btn-sm" style="color:#fff">Add</a>
        </div>
    </div>
            ...
            <tbody class="middle-align">
                <?php foreach ($items as $item): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo site_url('admin/service_providers/manage/' . $item->service_provider_id); ?>" class="btn btn-orange btn-sm btn-icon icon-left">
                                Edit
                            </a>

                            <a data-href="<?php echo site_url('admin/service_providers/delete/' . $item->service_provider_id); ?>" class="btn btn-danger btn-sm btn-icon btn-delete"
