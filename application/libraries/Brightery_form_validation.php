...
class __Brightery_Form_validation extends CI_Form_validation
{
...
class _Brightery_Form_validation extends CI_Form_validation {
...
/* End of file Brightery_form_validation.php */
/* Location: ./application/libraries/Brightery_form_validation.php */
     function ____file($var, $required = 0) {
        echo $var.$required."\n";
        print_r($_POST);
        die();
//        if($required) {
